...
def change_an_access(users, user_object, repo, give, pull=False):
    for user in users:
        if give:
            give_an_access(user, user_object, repo, pull)
        else:
...
def main():
    ...
    processing_access_list(github_object, give_an_access_list, True, pull)
